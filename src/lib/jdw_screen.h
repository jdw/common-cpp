...
public:
	Screen() {
		...
		/*
		Vertex<float>* xAxis = new Vertex<float>(V3<float>(-1.0f, 0.0f, 0.0f), V2<int>()); 
		xAxis->pNext = new Vertex<float>(V3<float>(1.0f, 0.0f, 0.0f), V2<int>()); 
	Vertex<float>* yAxis = new Vertex<float>(V3<float>(0.0f, -1.0f, 0.0f), V2<int>()); 
	yAxis->pNext = new Vertex<float>(V3<float>(0.0f, 1.0f, 0.0f), V2<int>()); 
	Vertex<float>* zAxis = new Vertex<float>(V3<float>(0.0f, 0.0f, -1.0f), V2<int>()); 
	zAxis->pNext = new Vertex<float>(V3<float>(0.0f, 0.0f, 1.0f), V2<int>());
	*/
	}
...
void DrawLine(const V2<int>& in_p0, const V2<int>& in_p1) {
